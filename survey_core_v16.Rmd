---
title: "Results of the core survey"
author: "Ivan Savin"
date: "24/01/2025"
...
# 
# table(data_clean$quota_age)
# 
# table(data_clean$quota_educ)
# #table(data_clean$quota_educ_AT)
# 
# table(data_clean$fit_55_knowl)
# 
# 
# table(data_clean$ETS_gen_support)
# 
# table(data_clean$ETS_rev_1)
# table(data_clean$ETS_rev_2)
# table(data_clean$ETS_rev_3)
# table(data_clean$ETS_rev_4)
# 
# table(data_clean$ETS_II_transp)
# table(data_clean$ETS_II_heat)
# table(data_clean$ETS_II_ag)
...
The average (median) length of the interview was 38 (22) minutes. Mainly because of a few outliers exceeding 100k seconds(!)

 As approx 500 people answered "dont know" to at least 1 out of 3 statements, the sample here is reduced from 19328 to 18464 observations.
...
#FOLOWING https://cran.r-project.org/web/packages/sBIC/vignettes/LatentClassAnalysis.pdf
...
# p + facet_wrap( ~ Question, scales="free")+  
#   scale_fill_manual(values=c("limegreen","cyan","magenta"),  
#                     name="", breaks=c("1","2","3")
...
p + facet_wrap( ~ Question, scales="free")+  
  scale_fill_manual(values=c("magenta","cyan","lightgreen", "darkgreen"),  
                    ...
                    ,labels=c("Degrowth","Agrowth","Green growth1","Green growth2")
                    )+ 
  theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
...
# library(nnet)
# 
# data_clean$GEMclusterF<-as.factor(data_clean$GEMclusterF)
# 
# data_clean$GEMclusterF <- relevel(data_clean$GEMclusterF, ref = "Agrowth")
# 
# MultiLogit = multinom(GEMclusterF ~ quota_gndr + quota_age + quota_educ + fit_55_knowl + 
#                         ETS_gen_support +  ETS_II_transp + ETS_II_heat + ETS_II_ag +
#                         CBAM + car_phase_all + EU_pol_beef  + EU_pol_rail  + EU_pol_pfli  + EU_pol_adban  + sec_order_me + sec_order_polit + clim_worry  + poli_ori + gen_trust_cnty + gen_trust_EU + 
#                         hh_inc + rural_urban + hh_size + car_use + food_consum + flight_freq, data=data_clean)
# #summary(MultiLogit)
...
# MultiLogit = multinom(GEMclusterF ~ quota_gndr + quota_age + quota_educ + fit_55_knowl + 
#                         #ETS_gen_support +  ETS_II_transp + ETS_II_heat + ETS_II_ag +
#                         #CBAM + car_phase_all + EU_pol_beef  + EU_pol_rail  + EU_pol_pfli  + EU_pol_adban  +
#                         val_pow1 + val_uni1 + val_sec1 + val_hed1 + val_selfd1 + val_bene1 + 
#                         val_ach1 + val_sec2 + val_stim1 + val_conf2 + val_trad1 + val_bio2 + 
#                         sec_order_me + sec_order_polit + clim_worry + poli_ori + gen_trust_cnty + 
#                         gen_trust_EU + hh_inc + rural_urban + hh_size + car_use + food_consum + flight_freq, data=data_clean)
# #summary(MultiLogit)
# stargazer(MultiLogit, type="text")
# 
# 
# data_clean$GEMclusterF <- relevel(data_clean$GEMclusterF, ref = "Green Growth")
# 
# MultiLogit = multinom(GEMclusterF ~ quota_gndr + quota_age + quota_educ + fit_55_knowl + 
#                         ETS_gen_support +  ETS_II_transp + ETS_II_heat + ETS_II_ag +
#                       CBAM + car_phase_all + EU_pol_beef  + EU_pol_rail  + EU_pol_pfli  + EU_pol_adban  + sec_order_me + sec_order_polit + clim_worry + poli_ori + gen_trust_cnty + gen_trust_EU + 
#                         hh_inc + rural_urban + hh_size + food_consum + flight_freq, data=data_clean)
# #summary(MultiLogit)
# stargazer(MultiLogit, type="text")
# 
# 
...
# 
# listcountries_GRADE<-listcountries
# 
# listcountries_GRADE$Country<- gsub("Austria", "AT",listcountries_GRADE$Country)
# listcountries_GRADE$Country<- gsub("Czech Republic", "CZ",listcountries_GRADE$Country)
# listcountries_GRADE$Country<- gsub("Germany", "DE",listcountries_GRADE$Country)
# listcountries_GRADE$Country<- gsub("Denmark", "DK",listcountries_GRADE$Country)
# listcountries_GRADE$Country<- gsub("Spain", "ES",listcountries_GRADE$Country)
# listcountries_GRADE$Country<- gsub("France", "FR",listcountries_GRADE$Country)
# listcountries_GRADE$Country<- gsub("Greece", "GR",listcountries_GRADE$Country)
# listcountries_GRADE$Country<- gsub("Hungary", "HU",listcountries_GRADE$Country)
# listcountries_GRADE$Country<- gsub("Italy", "IT",listcountries_GRADE$Country)
# listcountries_GRADE$Country<- gsub("Netherlands", "NL",listcountries_GRADE$Country)
# listcountries_GRADE$Country<- gsub("Poland", "PL",listcountries_GRADE$Country)
# listcountries_GRADE$Country<- gsub("Sweden", "SE",listcountries_GRADE$Country)
# listcountries_GRADE$Country<- gsub("Slovenia", "SI",listcountries_GRADE$Country)
# 
# data_clean$IMF.GDPpc<-matrix(NA,length(data_clean$ResponseId),1)
# data_clean$GDPpc_current<-matrix(NA,length(data_clean$ResponseId),1)
# data_clean$GDPpc_PPP<-matrix(NA,length(data_clean$ResponseId),1)
# data_clean$Gini<-matrix(NA,length(data_clean$ResponseId),1)
# data_clean$IHDI<-matrix(NA,length(data_clean$ResponseId),1)
# 
# countries<-unique(data_clean$cntry)
# for (ic in countries){
# data_clean$IMF.GDPpc[which(data_clean$cntry==ic)]<-listcountries_GRADE$IMF.GDPpc[which(listcountries_GRADE$Country==ic)]
# data_clean$GDPpc_current[which(data_clean$cntry==ic)]<-listcountries_GRADE$GDPpc_current[which(listcountries_GRADE$Country==ic)]
# data_clean$GDPpc_PPP[which(data_clean$cntry==ic)]<-listcountries_GRADE$GDPpc_PPP[which(listcountries_GRADE$Country==ic)]
# data_clean$Gini[which(data_clean$cntry==ic)]<-listcountries_GRADE$Gini[which(listcountries_GRADE$Country==ic)]
# data_clean$IHDI[which(data_clean$cntry==ic)]<-listcountries_GRADE$IHDI[which(listcountries_GRADE$Country==ic)]
# }
# summary(data_clean)
# 
# data_clean$GEMclusterF <- relevel(data_clean$GEMclusterF, ref = "Agrowth")
...
#                         ETS_gen_support +  ETS_II_transp + ETS_II_heat + ETS_II_ag +
#                         CBAM + car_phase_all + EU_pol_beef  + EU_pol_rail  + EU_pol_pfli  + EU_pol_adban  + sec_order_me + sec_order_polit + clim_worry + poli_ori + gen_trust_cnty + gen_trust_EU + 
#                         hh_inc + rural_urban + hh_size + car_use + food_consum + flight_freq +
#                         GDPpc_current + GDPpc_PPP + Gini + IHDI
#                         , data=data_clean)
# #summary(MultiLogit)
# stargazer(MultiLogit, type="text")
# 
# 
# 
# DataCorrplot<-data_clean[,c(52:55, 67, 70:73)]
# 
# library(tidyverse)
# 
...
#     formula <- paste("WeightedGrowthSupport ~", paste(factors, collapse = "+"))
#     m <- lm(formula, data = data_cleaned)
#     summary(m)$r.squared[1]
# }
# Rpseudo<-reg_pformula(c("quota_gndr","quota_age","quota_group_educ","fit_55_knowl",
#                          "ETS_gen_support","ETS_II_transp","ETS_II_heat","ETS_II_ag","CBAM","car_phase_all","EU_pol_beef","EU_pol_rail","EU_pol_pfli","EU_pol_adban",
#                         "val_pow1","val_uni1"," val_sec1","val_hed1","val_selfd1","val_bene1","val_ach1","val_sec2","val_stim1","val_conf2","val_trad1","val_bio2","sec_order_me",
#                         "sec_order_polit",
#                         "clim_worry","poli_ori","gen_trust_cnty","gen_trust_EU","hh_inc_wth","rural_urban","hh_size","car_use","flight_freq"))
# test<-shapley(reg_pformula, c("quota_gndr","quota_age","quota_group_educ","fit_55_knowl",
#                          "ETS_gen_support","ETS_II_transp","ETS_II_heat","ETS_II_ag","CBAM","car_phase_all","EU_pol_beef","EU_pol_rail","EU_pol_pfli","EU_pol_adban",
#                         "val_pow1","val_uni1"," val_sec1","val_hed1","val_selfd1","val_bene1","val_ach1","val_sec2","val_stim1","val_conf2","val_trad1","val_bio2","sec_order_me",
#                         "sec_order_polit",
#                         "clim_worry","poli_ori","gen_trust_cnty","gen_trust_EU","hh_inc_wth","rural_urban","hh_size","car_use","flight_freq"), silent = TRUE)
...
```{r MLOGIT, echo=FALSE}
data_cleaned$GEMclusterF[which(data_cleaned$GEMclusterF=="Degrowth")]<-"(b) Degrowth"


data_cleaned$GEMclusterF <- as.factor(data_cleaned$GEMclusterF)
data_cleaned$GEMclusterF <- factor(data_cleaned$GEMclusterF, 
                                    levels = c("(b) Degrowth", "Agrowth", "Pro-growth moderate", "Pro-growth strong"))
...
model_levels <- c("(b) Degrowth", "Agrowth", "Pro-growth strong")
...
#                         CBAM  + EU_pol_rail + CNTY_pol_beef + CNTY_pol_insu + CNTY_pol_taxff + CNTY_pol_taxfly +
#                         car_phase_all + EU_pol_beef  + EU_pol_pfli  + EU_pol_adban
#                        + cntry
# 
#                         , data=data_cleaned)
...
# 
# dwplot(OLS22,vars_order=c("ETS_gen_support","ETS_II_transp","ETS_II_heat","ETS_II_ag","CBAM","EU_pol_rail","CNTY_pol_beef","CNTY_pol_insu","CNTY_pol_taxff","CNTY_pol_taxfly","car_phase_all","EU_pol_beef","EU_pol_pfli","EU_pol_adban"),
#        vline = geom_vline(
#            xintercept = 0,
#            colour = "black",
#            linetype = 2
...
```{r, echo=FALSE}
# 
# OLS2 = lm(WeightedGrowthSupport ~ quota_gndr + quota_age + quota_group_educ + fit_55_knowl +
#                         ETS_gen_support +  ETS_II_transp + ETS_II_heat + ETS_II_ag +
#                         CBAM + car_phase_all + EU_pol_beef  + EU_pol_rail  + EU_pol_pfli  + EU_pol_adban  +
#                         # val_pow1 + val_uni1 + val_sec1 + val_hed1 + val_selfd1 + val_bene1 +
#                         # val_ach1 + val_sec2 + val_stim1 + val_conf2 + val_trad1 + val_bio2 +
#                         # sec_order_me + sec_order_polit + 
#                         clim_worry + poli_ori + gen_trust_cnty +
#                         gen_trust_EU + hh_inc_wth + rural_urban + hh_size + car_use + food_consum + flight_freq
#                         +cntry
#                         , data=data_cleaned)
# #summary(MultiLogit)
...
# 
# data_cleaned$GEMclusterF <- as.factor(data_cleaned$GEMclusterF)
# data_cleaned$GEMclusterF <- relevel(data_cleaned$GEMclusterF, ref = "Agrowth")
# 
# 
# MultiLogit2 = multinom(GEMclusterF ~ quota_gndr + quota_age + quota_group_educ + fit_55_knowl +
#                         ETS_gen_support +  ETS_II_transp + ETS_II_heat + ETS_II_ag +
#                         CBAM + car_phase_all + EU_pol_beef  + EU_pol_rail  + EU_pol_pfli  + EU_pol_adban  +
#                         # val_pow1 + val_uni1 + val_sec1 + val_hed1 + val_selfd1 + val_bene1 +
#                         # val_ach1 + val_sec2 + val_stim1 + val_conf2 + val_trad1 + val_bio2 +
...
#                       , data=data_cleaned)
# #summary(MultiLogit)
# stargazer(MultiLogit2, type="text")
```
...
```{r, echo=FALSE}
# 
# OLS3 = lm(WeightedGrowthSupport ~ quota_gndr + quota_age + quota_group_educ + fit_55_knowl +
#                         #ETS_gen_support +  ETS_II_transp + ETS_II_heat + ETS_II_ag +
#                         #CBAM + car_phase_all + EU_pol_beef  + EU_pol_rail  + EU_pol_pfli  + EU_pol_adban  +
#                         # val_pow1 + val_uni1 + val_sec1 + val_hed1 + val_selfd1 + val_bene1 +
#                         # val_ach1 + val_sec2 + val_stim1 + val_conf2 + val_trad1 + val_bio2 +
...
# 
# 
# MultiLogit3 = multinom(GEMclusterF ~ quota_gndr + quota_age + quota_group_educ + fit_55_knowl +
#                         #ETS_gen_support +  ETS_II_transp + ETS_II_heat + ETS_II_ag +
#                         #CBAM + car_phase_all + EU_pol_beef  + EU_pol_rail  + EU_pol_pfli  + EU_pol_adban  +
#                         # val_pow1 + val_uni1 + val_sec1 + val_hed1 + val_selfd1 + val_bene1 +
#                         # val_ach1 + val_sec2 + val_stim1 + val_conf2 + val_trad1 + val_bio2 +
...
#                       , data=data_cleaned)
# #summary(MultiLogit)
# stargazer(MultiLogit3, type="text")
```
